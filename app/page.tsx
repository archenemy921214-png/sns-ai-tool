...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-indigo-100 px-4">
      <div className="max-w-2xl text-center space-y-6">
        ...
        <h1 className="text-5xl font-bold tracking-tight text-gray-900">PostAI</h1>
